...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BeforeText = getString(R.string.country_city);
        correct1=0;
        wrong1=0;
    ...
    public void pickRandomWords() {
        ...
        theWordView.setText(BeforeText+" "+theWord);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    Toast.makeText(MainActivity.this, R.string.Well_done, Toast.LENGTH_SHORT).show();
                    correct1++;
                } else {
                    Toast.makeText(MainActivity.this, R.string.Bad_done, Toast.LENGTH_SHORT).show();
                    wrong1++;
                }
                pickRandomWords();
            }
